...
// ---------------------------------------------------------------
// Get the connection point of the HTML control.
IConnectionPoint *HTMLContainer::GetConnectionPoint (REFIID riid)
{
	// Get the interface of the HTML control.
	...
	// Query the interface so that the connection point can be found.
...
// Synchronises the size of the component to the window it is embedded in. Is this actually used anywhere?
